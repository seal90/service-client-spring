...
public class RSocketWebServerSmartLifecycle implements SmartLifecycle {
    ...
    public RSocketWebServerSmartLifecycle(HttpHandler httpHandler, RSocketStrategies rsocketStrategies) {
