...
import io.github.seal90.serviceclient.carries.by.grpc.protocoltypefactory.grpc.extension.CarriesByGrpcMethodInterceptor;
...
import static io.github.seal90.serviceclient.carries.by.grpc.protocoltypefactory.grpc.extension.CarriesByGrpcTransactionManager.TRANSACTION_CONTEXT;
...
public class ProtocolTypeCarriesByGrpcFactory implements ProtocolTypeFactory, ApplicationContextAware, EnvironmentAware, InitializingBean {
  ...
  public <T> T create(Member injectionTarget, Class<T> injectionType, ServiceClient annotation) {
    ...
    AnnotationAttributes annotationAttributes = AnnotatedElementUtils.findMergedAnnotationAttributes(
            injectionType, MessageMapping.class, true, true);
    ...
    try {
      ...
      return (T) ProxyFactory.getProxy(injectionType, new CarriesByGrpcMethodInterceptor(serviceName, stub));
      ...
      public <ReqT, RespT> ClientCall<ReqT, RespT> interceptCall(final MethodDescriptor<ReqT, RespT> method,
        ...
        return new ForwardingClientCall.SimpleForwardingClientCall<ReqT, RespT>(next.newCall(method, callOptions)) {
          ...
          public void start(Listener<RespT> responseListener, Metadata headers) {
            CarriesByGrpcTransactionManager.TransactionContext transactionContext = TRANSACTION_CONTEXT.get();
            if(transactionContext != null && transactionContext.getTransactionId() != null) {
              headers.put(Metadata.Key.of("servicefilter-transaction-id", Metadata.ASCII_STRING_MARSHALLER), transactionContext.getTransactionId());
            }
