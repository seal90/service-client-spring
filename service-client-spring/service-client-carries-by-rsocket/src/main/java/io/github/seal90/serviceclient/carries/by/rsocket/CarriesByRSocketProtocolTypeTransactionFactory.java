...
import io.github.seal90.serviceclient.carries.by.rsocket.extension.CarriesByRSocketTransactionManager;
...
public class CarriesByRSocketProtocolTypeTransactionFactory implements ProtocolTypeFactory {
    ...
    public CarriesByRSocketProtocolTypeTransactionFactory(ApplicationContext applicationContext, Environment environment
...
//        RSocketRequester.Builder builder = applicationContext.getBean(RSocketRequester.Builder.class);
        ...
        MessageRSocket messageRSocket = interceptors.stream()
                .reduce(
                        ...
                        (a, b) -> a);
        ReactiveTransactionManager transactionManager = new CarriesByRSocketTransactionManager(serviceName, rSocketRequester, messageRSocket);
        TransactionalOperator transactionalOperator = TransactionalOperator.create(transactionManager);
        return (T)transactionalOperator;
    }

    @Override
    public String supportProtocol() {
        return "CARRIES_BY_RSOCKET_TRANSACTION";
    }
}
