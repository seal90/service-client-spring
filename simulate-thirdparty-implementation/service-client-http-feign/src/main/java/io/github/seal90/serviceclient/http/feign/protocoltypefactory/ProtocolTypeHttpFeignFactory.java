package io.github.seal90.serviceclient.http.feign.protocoltypefactory;
...
import io.github.seal90.serviceclient.core.ServiceClientAnnotationBeanPostProcessor;
import io.github.seal90.serviceclient.http.feign.ProtocolTypeHttpFeign;
import io.github.seal90.serviceclient.http.feign.protocoltypefactory.feign.extension.FeignClientFactoryBeanExtension;
...
public class ProtocolTypeHttpFeignFactory implements ProtocolTypeFactory, ApplicationContextAware {
...
//    Object obj = registerSingletonBean(finalChannelName, factoryBean);
  ...
  public String supportProtocol() {
    return ProtocolTypeHttpFeign.HTTP_FEIGN;
  }
